...
{
	/**
     * 所有行的内容 :page lines line
     */
    protected ArrayList<ArrayList<WordWithTextPositions>> pageLines = new ArrayList<ArrayList<WordWithTextPositions>>();;        	// 所有行内容.
    private LineItemComparator comparator = new LineItemComparator();
    //
    //
    //
    ...
    protected String paragraphStart = "";
    protected String paragraphEnd = "";
    protected String pageStart = "";
    protected String pageEnd = LINE_SEPARATOR;
    protected String articleStart = "";
    protected String articleEnd = "";
    ...
    {
    	// to get color
    	// http://mail-archives.us.apache.org/mod_mbox/pdfbox-dev/201801.mbox/%3CJIRA.13130150.1515665780000.635835.1515744600492@Atlassian.JIRA%3E
    ...
    protected void writePage() throws IOException
    {
        ...
        // 存放所有的行
        ArrayList<WordWithTextPositions> lines = new ArrayList<WordWithTextPositions>();
        ...
        for (List<TextPosition> textList : charactersByArticle)
        {
            ...
            while (textIter.hasNext())
            {
                ...
                /*
                System.out.print(position.getUnicode()+" "+position.getXDirAdj()+" ||| ");
    ...
    protected void processTextPosition(TextPosition text)
    {
        ...
        text.setColor(nonStrokingColor);
        text.setColorSpace(colorSpace);
        ...
        //System.out.println("Color space:        " + colorSpace.getName());
        //System.out.println();
    }
    ...
    /**
     * By default the text stripper will invisible to remove text that overlapps each other. Word paints the same
    ...
    private class LineItemComparator implements Comparator<LineItem>
    {
        public int compare(LineItem pos1, LineItem pos2)
        {
            // only compare text that is in the same direction
        	if(pos1.getTextPosition() == null || pos1.getTextPosition() == null) {
        		return 0;
        	}
            if (pos1.getTextPosition().getDir() < pos2.getTextPosition().getDir())
            {
                return -1;
            }
            else if (pos1.getTextPosition().getDir() > pos2.getTextPosition().getDir())
            {
                return 1;
            }
