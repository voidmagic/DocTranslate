...
public final class TextPosition
{
    ...
    public boolean isDiacritic()
    {
        ...
        if ("銉�".equals(text))
        {
            // PDFBOX-3833: 銉� is not a real diacritic like 篓 or 藛, it just changes the 
	...
	public String getColorInfo() {
		return colorSpace.toString()+color.toString();
	}
	
	public boolean isSameColor(TextPosition tp) {
		String tpColorInfo = tp.getColorInfo();
		return (getColorInfo().equals(tpColorInfo));
	}
